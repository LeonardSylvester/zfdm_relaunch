...
hero:
  ...
  customer:
    image:
      ...
      - "/images/home/3.png"
      - "/images/home/4.png"
    note: "Über 1600+ KMU vertrauen <br>uns bereits ihre Zeit an"

feature:
  title: "Unsere Zeiterfassungssysteme"
  subtitle: "Drei verschiedene Systeme zur Zeiterfassung. Welches passt zu Ihnen? Alle Systeme sind sofort einsatzbereit und einfach zu bedienen, danke App und Software."
  features:
    - title: "RFID-Chip"
      badge: "Einfach"
      content: "Einfache Zeiterfassung <br> per Chip am Terminal"
...
offering:
  - title: "Zeit, Geld & Nerven sparen"
    subtitle: "Schluss mit dem Zettelchaos"
    image: "/images/ZFDM-Zeiterfassung-Vorteil-Erfassen.webp"
    image_1: ""
    ...
    points:
      - "Automatische Berechnung von Arbeitszeiten, Pausen und Überstunden – keine manuellen Excel-Listen mehr nötig. Sparen Sie bis zu 80% Verwaltungsaufwand in der Lohnabrechnung."
      - "Manipulationssichere Erfassung verhindert Zeitbetrug und Abrechnungsfehler. Transparente Zeitdaten reduzieren Rückfragen und Konflikte um durchschnittlich 70%."
  - title: "Transparenz schaffen"
    subtitle: "Keine Rückfragen mehr"
    image: "/images/ZFDM-Zeiterfassung-Vorteil-Exportieren.webp"
    image_1: ""
    ...
    points:
      - "Jederzeit Einsicht in Urlaubstage, Überstunden und Arbeitszeiten – für Mitarbeitende per App, für Führungskräfte im Dashboard. Alle Daten DSGVO-konform und revisionssicher gespeichert."
      - "Automatische Reports für Lohnabrechnung, Controlling und Betriebsprüfungen auf Knopfdruck. Exportieren Sie alle Zeitdaten direkt in Ihr Lohnabrechnungssystem."
  - title: "Mitarbeiter motivieren"
    subtitle: "Eigenverantwortung fördern"
    image: "/images/ZFDM-Zeiterfassung-Vorteil-Planen.webp"
    image_1: ""
    content: "Eine digitale Zeiterfassung schafft Fairness, stärkt die Eigenverantwortung und steigert nachweislich die Motivation im Team. Durch transparente und nachvollziehbare Arbeitszeiten – etwa bei Pausen oder Zusatzleistungen – fühlen sich Mitarbeitende gerechter bewertet und bringen erfahrungsgemäß mehr Engagement und Effizienz in ihren Arbeitsalltag ein."
    points:
      - "Flexible Arbeitszeitmodelle wie Gleitzeit, Home-Office oder Vertrauensarbeitszeit digital abbilden. Mitarbeitende sehen ihre Zeitkonten in Echtzeit und können eigenverantwortlich planen."
      - "Faire Dokumentation von Mehrleistungen und Überstunden schafft Wertschätzung. Studien zeigen: Transparente Zeiterfassung steigert die Arbeitszufriedenheit um bis zu 30%."

benefits:
  title: "Alle Funktionen im Überblick"
  subtitle: "Zeiterfassung - wie Sie sein sollte: Ohne Abo, rechtssicher & stressfrei"
  points:
    - title: "RFID-Chip Stempeln am Terminal"
      content: "Kontaktloses Ein- und Ausstempeln via Chip am Terminal – schnell, fehlerarm und ohne Passwort-Eingabe."
      icon: "FaWifi"
      image: ""
    - title: "Stempeln per Web/App (Homeoffice & unterwegs)"
      content: "Erfassung der Arbeitszeiten auch über Web-Oberfläche oder App von unterwegs oder im Homeoffice – maximale Flexibilität."
      icon: "FaMobileScreen"
      image: ""
    - title: "Web-Administration im Browser"
      content: "Verwaltung von Mitarbeitenden, Buchungen und Auswertungen bequem im Browser – ohne Softwareinstallation."
      icon: "FaDesktop"
      image: ""
    - title: "Urlaubs- & Fehlzeitenverwaltung"
      content: "Abwesenheiten, Pausen sowie Krank- und Ausfallzeiten digital erfassen und automatisieren."
      icon: "FaCalendarXmark"
      image: ""
    - title: "Automatische E-Mail-Benachrichtigungen"
      content: "Vorgesetzte werden automatisch über Buchungen oder Abwesenheiten informiert – keine manuelle Kontrolle nötig."
      icon: "FaEnvelope"
      image: ""
    - title: "Berichte & Exporte (Excel/PDF/DATEV)"
      content: "Datenexport als Excel-, PDF- oder DATEV-Format zur Weiterverarbeitung in der Lohnbuchhaltung oder Auswertung."
      icon: "FaFileLines"
      image: ""
    - title: "Netzwerk-/WLAN-fähig"
      content: "Die Terminals sind netzwerk- und WLAN-fähig – für flexible Installation ohne feste Verkabelung."
      icon: "FaWifi"
      image: ""
    - title: "Automatische Datensicherung (Backups)"
      content: "Regelmäßige Datensicherung lokal – damit Ihre Daten geschützt und DSGVO-konform bleiben."
      icon: "FaDatabase"
      image: ""
    - title: "Eigenes Logo in Webinterface & Reports"
      content: "Individuelle Anpassung mit Ihrem Firmenlogo – für Weboberfläche wie auch generierte Reports."
      icon: "FaImage"
      image: ""
    - title: "Erweiterbar & skalierbar"
      content: "Das System wächst mit Ihrem Unternehmen – neue Mitarbeitende oder Terminals lassen sich einfach hinzufügen."
      icon: "FaChartLine"
      image: ""
    - title: "DSGVO-konform & lokale Datenhoheit"
      content: "Ihre Daten bleiben im Haus, keine externe Cloud – volle Kontrolle und gesetzeskonforme Speicherung."
      icon: "FaShield"
      image: ""
    - title: "Video-Anleitung & Schulungsmaterial"
      content: "Schritt-für-Schritt-Videos und PDF-Guides erleichtern die Einführung und sorgen für reibungslose Nutzung durch Mitarbeitende."
      icon: "FaVideo"
      image: ""
    - title: "Spesen- & Nachtzuschläge"
      content: "Frei definierbare Tarife für Spesen oder Nacht-/Schichtzuschläge, automatisch ausweisbar für die Lohnabrechnung."
      icon: "FaEuroSign"
      image: ""
    - title: "Korrektur nachträglicher Zeitangaben"
      content: "Nachgereichte oder fehlende Buchungen (z. B. durch Dienstreisen) können im System bearbeitet und korrekt erfasst werden."
      icon: "FaPencil"
      image: ""
